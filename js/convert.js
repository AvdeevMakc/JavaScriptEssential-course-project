...
function showResult() {
    ...
    showCoursNow.innerHTML = `${converterInputFirst.value} ${converterSelectFirst.value} = `; /* ${(first / second).toFixed(2)} */

    showResultNow.innerHTML = `${result.toFixed(2)} ${converterSelectSecond.value}`;
